...
<main class="informations-section">
  <!-- HUILES ESSENTIELLES -->
  <article class="sub-section" id="oils">
    {#if $windowSize.width >= 1300}
      <div class="image-part-left" data-aos="fade-right">
        <Organic shape={1} color="blue" class="organic1" />
        <img src={oilsImg} class="img-size" alt="Flacons d'huiles essentielles naturelles" />
      </div>
    {/if}
    <div class="text-part-right" data-aos="fade-left">
      <h2 class="title">HUILES ESSENTIELLES</h2>
      {#if $windowSize.width < 1300}
        <div class="image-part-left" data-aos="fade-right">
          <img src={oilsImg} class="img-size" alt="Flacons d'huiles essentielles naturelles" />
        </div>
      ...
      <CustomButton class="button-align" link="tarif">Voir les tarifs</CustomButton>
    </div>
  </article>

  <!-- FLEURS DE BACH -->
  <article class="sub-section" id="bach">
    <div class="text-part-left" data-aos="fade-right">
      <h2>FLEURS DE BACH</h2>
      {#if $windowSize.width < 1300}
        <div class="image-part-right" data-aos="fade-left">
          <img src={bachImg} class="img-size-right" alt="Fleurs de Bach pour l'équilibre émotionnel" />
        </div>
      {/if}
      <p>
  ...
  <!-- MASSAGE ASSIS -->
  <article class="sub-section" id="massage">
    {#if $windowSize.width >= 1300}
      <div class="image-part-left" data-aos="fade-right">
        <Organic shape={1} color="blue" class="organic1 organic1-rotate" />
        <img src={massageImg} class="img-size" alt="Séance de massage assis AMMA sur chaise ergonomique" />
      </div>
    {/if}
    <div class="text-part-right" data-aos="fade-left">
      <h2>MASSAGE ASSIS</h2>
  ...
  <!-- SOIN SIGNATURE -->
  <article class="sub-section" id="signature-soin">
    <div class="text-part-left" data-aos="fade-right">
      <h2>SOIN SIGNATURE</h2>
      {#if $windowSize.width < 1300}
        <div class="image-part-right" data-aos="fade-left">
          <img src={signatureImg} class="img-size-right" alt="Soin signature des mains et avant-bras" />
        </div>
      {/if}
      <p>
...
<style lang="scss">
  ...
  .img-size {
    box-shadow: -12px 12px 0px 0px $secondary2;
    width: 450px;
    border-radius: 12px;
    ...
    &:hover {
      ...
      box-shadow: -16px 16px 0px 0px $secondary2;
    }
  }
